...
const Signup = ({
  ...
  const checkValidity = (error, touched) => {
    ...
    if (error && touched)
      errorMessageElement.push(classes.Signup__paragraph_show);
    ...
    <>
      <Form className={classes.Signup}>
        ...
        <div>
          ...
          <Field
            className={checkInputValidity(errors.firstName, touched.firstName)}
            type="text"
            name="firstName"
...
const formikApp = withFormik({
  ...
  validationSchema: Yup.object().shape({
    ...
    repeatPassword: Yup.string()
      .oneOf([Yup.ref("password"), null], "Both password must be the same!")
